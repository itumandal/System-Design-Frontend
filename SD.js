...
//! Best Optimization way approach 
    ...
    //? here HTML parsing continues and when it reach to script tag it sees async then it simultaneously download js code & html parsing continues. when js is downloaded it starts executing and that time html parsing stops & execute JS. once done then HTML parsing is continued.

    //! with Defer attribute in HEAD tag
    //? HTML parsing continuos + pre-fetching JS script simultaneously and then when the HTML parsing is completed then JS execution phase starts.
